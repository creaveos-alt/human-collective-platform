...
import { DonationModal, EventModal } from "./CTAModals";

// Also export the Creative Header with constellation nodes
export { CreativeHeaderPreview } from "./CreativeHeaderPreview";

// Enhanced HeaderPreview with interactive CTAs (Traditional button style)
export function EnhancedHeaderPreview({ content }: any) {
      ...
      <div className="space-y-6">
        ...
        <div className="p-3 bg-gradient-to-r from-[#65D6C8]/20 to-[#7A6FF0]/20 border-2 border-[#65D6C8]/40 rounded-lg text-center">
          <div className="flex items-center justify-center gap-2">
            ...
            <p className="text-sm text-[#FDFDFB] font-medium">🔲 TRADITIONAL BUTTONS DESIGN — Rectangular Buttons</p>
          </div>
        </div>
        ...
        <div className="p-4 bg-[#7A6FF0]/5 border border-[#7A6FF0]/20 rounded-lg space-y-2">
          ...
          <div className="text-xs text-[#FDFDFB]/60 space-y-1">
            {content.showCtasInHeader ? (
              <>
                <p>• <strong>Donate:</strong> Opens museum plinth modal with soft dimmed overlay (click to test!)</p>
                <p>• <strong>Join Event:</strong> Triggers lateral aurora-slide panel from right (click to test!)</p>
                <p>• <strong>Hover Effects:</strong> Shimmer gradient, inner glow pulse, scale transform</p>
                <p>• <strong>Typography:</strong> Medium weight, tracking-wide, proportional rhythm (8–12px gaps)</p>
                <p>• <strong>Narrative:</strong> "Each gesture, a spark in the continuum."</p>
              </>
            ) : (
              <>
...
export function EnhancedHeroPreview({ content }: any) {
  const [showDonateModal, setShowDonateModal] = useState(false);
  const [showEventModal, setShowEventModal] = useState(false);
  ...
  return (
    <>
      <div className="relative py-20">
        {/* Ambient Glow Background - Animated */}
        ...
        <div className="relative space-y-16 text-center">
          {/* Acheulean Mark (Aurora Crystal Symbol) - Enhanced */}
          <motion.div 
            ...
            >
              ...
              <div className="relative">
                ...
                <motion.div
                  ...
                  className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-32 bg-gradient-to-r from-[#7A6FF0]/20 via-[#65D6C8]/20 to-[#7A6FF0]/20 blur-3xl rounded-full pointer-events-none"
                />
                ...
                <div className="relative flex items-center justify-center gap-6">
                  ...
                  >
                    {/* Shimmer Wave Effect */}
                    <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 bg-gradient-to-r from-transparent via-[#FDFDFB]/15 to-transparent"></div>
                    <span className="relative z-10">{content.ctaEvent}</span>
                  </button>
                </div>
              </div>
            ...
            >
              <div className="space-y-3 text-left">
                ...
                <div className="text-xs text-[#FDFDFB]/60 leading-relaxed space-y-2">
                  ...
                  <p>• <strong>Donate interaction:</strong> Opens soft dimmed overlay modal — illuminated plinth in museum darkness (click to test!)</p>
                  <p>• <strong>Event interaction:</strong> Triggers lateral slide overlay from right — aurora-edged panel with ambient motion (click to test!)</p>
                  <p>• <strong>Hover micro-animations:</strong> Inner glow pulse (Donate), gradient shimmer wave (Event), scale transforms</p>
                  <p>• <strong>Breathing crystal:</strong> Subtle rotation (6s) and pulsing rings (4s) create living, inviting atmosphere</p>
                  <p>• <strong>Narrative rhythm:</strong> Symbol breathes → Headlines appear → CTAs emerge with aurora support</p>
                  <p>• <strong>Thresholds of intention:</strong> Every button feels like a quiet act of purpose, glowing softly in darkness</p>
                </div>
              </div>
            </motion.div>
          )}
