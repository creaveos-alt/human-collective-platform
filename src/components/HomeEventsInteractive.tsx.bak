    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-20">
          ...
          >
            <h2 className="text-5xl md:text-6xl text-[#EAF0FF] mb-6">
              Upcoming Events
            </h2>
          ...
          <div className="relative">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-[#111931]/90 border border-[#65D6C8]/40 backdrop-blur-sm transition-all duration-400"
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.1, boxShadow: "0 0 20px rgba(101,214,200,0.4)" }}
              whileTap={{ scale: 0.95 }}
              className="absolute right-0 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-[#111931]/90 border border-[#65D6C8]/40 backdrop-blur-sm transition-all duration-400"
                ...
                {visibleCards.map((event, i) => (
                  ...
                  >
                    <motion.div
                      ...
                      className={`relative p-8 rounded-2xl backdrop-blur-sm border transition-all duration-400 ${
                        event.isFlagship
                    ...
                    >
                      ...
                      <div className="relative z-10 space-y-4">
                        ...
                        <h3 className="text-xl text-[#EAF0FF] leading-tight">
                          {event.name}
                        </h3>

                        <p className="text-sm text-[#9BB2E1] leading-relaxed line-clamp-3">
                          {event.description}
                        </p>
                        ...
                        <div className="flex gap-2 pt-2">
                          <motion.button
                            ...
                            className="flex-1 px-4 py-2.5 rounded-lg bg-gradient-to-r from-[#65D6C8] to-[#7A6FF0] text-[#040619] text-sm font-medium transition-all flex items-center justify-center gap-1.5"
                          >
                            Join Event
                          ...
                          <motion.button
                            ...
                            className="px-4 py-2.5 rounded-lg border border-[#FDFDFB]/20 text-[#FDFDFB] text-sm hover:bg-[#FDFDFB]/5 transition-all"
                          >
                            Learn More
                          </motion.button>
                        </div>
